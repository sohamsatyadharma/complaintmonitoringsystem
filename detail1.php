					...
					<div class="col-sm-10">
						<div class="blog-post blog-single-post">
							<div class="single-post-title-detail">
								...
								<h2 id="detailhead" style="color:#000;"> Baby among three dead after driver mows down pedestrians in Kolkata, wounding dozens </h2>
                                <h4 id="below-detail-head" style=" margin-top:-4px"></h4>
							</div>

							<div class="single-post-image-detail">
								<img src="img/news/no1.jpg">
							</div>
							<div class="single-post-info">
								<i class="glyphicon glyphicon-time"></i>18 JAN, 2017
							</div>							
